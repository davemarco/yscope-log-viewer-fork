...
class YscopeFormatter implements Formatter {
    ...
    constructor (options: FormatterOptionsType) {
        this.#containsAutoGeneratedKeys = options.containsAutoGeneratedKeys;
    ...
    #parseFieldPlaceholder () {
        ...
        for (const match of it) {
            ...
            const {isAutoGenerated, fieldNameKeys, formatterName, formatterOptions} =
                splitFieldPlaceholder(groupMatch, this.#containsAutoGeneratedKeys);
