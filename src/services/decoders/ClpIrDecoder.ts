...
import {Formatter, ParsedFilterKey} from "../../typings/formatters";
...
interface StructuredIrReaderOptions {
    logLevelKey: ParsedFilterKey;
    timestampKey: ParsedFilterKey;
}
...
class ClpIrDecoder implements Decoder {
    ...
    constructor (
        ...
        if (streamType === CLP_IR_STREAM_TYPE.STRUCTURED) {
            this.#formatter = new YscopeFormatter({formatString: decoderOptions.formatString, containsAutoGeneratedKeys: true});
    ...
    #parseDecoderOptions (
        ...
        return {
            logLevelKey: ParsedFilterKey(decoderOptions.logLevelKey),
            timestampKey: ParsedFilterKey(decoderOptions.timestampKey)
        }
    }
